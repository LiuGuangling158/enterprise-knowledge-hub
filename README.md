...
基于规划文档搭建的全栈项目，当前已补齐 V1 主链路：登录鉴权、文档创建/编辑/保存、上传解析、提交审批、文档级审批轨迹、协作评论、审批通过/驳回、基础搜索、权限隔离入口，并为 V2/V3 的 Agent 编排、RAG、多路召回、SSE、MCP、A2A 与 Skills 预留模块边界。
...
前端默认请求 `http://localhost:8000`。可在 `frontend/.env` 中配置 `VITE_API_BASE_URL`。
...
- 文档新建、编辑、版本记录、上传解析、协作评论、提交审批、审批通过/驳回
